...
interface ButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
  variant?: 'contained' | 'outlined' | 'text' | 'primary' | 'secondary' | 'icon';
...
const getVariantClasses = (variant: string, color: string) => {
  const colorMap = {
    ...
    success: {
      contained: 'bg-success-500 hover:bg-success-600 text-white shadow-sm hover:shadow-md',
      outlined: 'border-2 border-success-500 text-success-600 hover:bg-success-50 bg-transparent',
      text: 'text-success-600 hover:bg-success-50 bg-transparent',
    },
    error: {
      contained: 'bg-error-500 hover:bg-error-600 text-white shadow-sm hover:shadow-md',
      outlined: 'border-2 border-error-500 text-error-600 hover:bg-error-50 bg-transparent',
      text: 'text-error-600 hover:bg-error-50 bg-transparent',
    },
    warning: {
      contained: 'bg-warning-500 hover:bg-warning-600 text-white shadow-sm hover:shadow-md',
      outlined: 'border-2 border-warning-500 text-warning-600 hover:bg-warning-50 bg-transparent',
