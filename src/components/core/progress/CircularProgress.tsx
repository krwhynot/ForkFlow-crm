...
export const CircularProgress: React.FC<CircularProgressProps> = ({
    ...
    const sizeClass = typeof size === 'number' ? '' : SIZE_VARIANTS[size as keyof typeof SIZE_VARIANTS];
    ...
    const strokeDashoffset = isIndeterminate ? 0 : circumference - (progressValue / 100) * circumference;
