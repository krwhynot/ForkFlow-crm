                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    <Card className="opacity-50">
                        <CardContent className="text-center py-6">
                            ...
                            <Typography variant="h4" className="text-gray-400 font-bold mb-1">
                                --
                            </Typography>
                    ...
                    <Card className="opacity-50">
                        <CardContent className="text-center py-6">
                            <CurrencyDollarIcon className="h-8 w-8 text-gray-400 mx-auto mb-3" />
                            <Typography variant="h4" className="text-gray-400 font-bold mb-1">
                                --
                            </Typography>
                            <Typography variant="body2" className="text-gray-400">
                ...
                <CardContent>
                    <div className="space-y-4">
                        <div className="flex items-center space-x-4 p-4 bg-primary-50 rounded-lg">
                            ...
                            <div>
                                <Typography variant="subtitle2" className="text-primary-800">
                                    Phase 1: Basic Reporting (Q2 2024)
                                </Typography>
                                <Typography variant="body2" className="text-primary-600">
                                    Contact lists, organization summaries, basic export functionality
                                </Typography>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center space-x-4 p-4 bg-gray-50 rounded-lg">
                            ...
                            <div>
                                ...
                                <Typography variant="body2" className="text-gray-600">
                                    Sales performance metrics, revenue forecasting, trend analysis
                                </Typography>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center space-x-4 p-4 bg-gray-50 rounded-lg">
                            ...
                            <div>
                                <Typography variant="subtitle2" className="text-gray-800">
                                    Phase 3: Custom Dashboards (Q4 2024)
                                </Typography>
                                <Typography variant="body2" className="text-gray-600">
                                    Personalized reports, scheduled exports, team collaboration features
                                </Typography>
                            </div>
                        </div>
                    </div>
