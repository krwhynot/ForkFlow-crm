...
describe('Interaction Tracking E2E Workflow', () => {
    ...
    beforeAll(async () => {
        ...
        await page.waitForSelector('[data-testid="dashboard"], .RaLayout-content', { timeout: 10000 });
    });
    ...
    describe('Complete Interaction Creation Workflow', () => {
        it('should create a new interaction with GPS location', async () => {
            ...
            await expect(page.locator('text=Interaction Details')).toBeVisible();

            // Fill out the organization field
            await page.click('[data-testid="organizationId-input"] input');
            await page.type('[data-testid="organizationId-input"] input', 'Acme Corp');
            ...
            // Fill out subject
            await page.fill('[data-testid="subject-input"] input', 'Product demonstration meeting');

            // Fill out description
            await page.fill('[data-testid="description-input"] textarea', 'Demonstrated our new product line to the customer team');

            // Verify GPS section appears for in-person interaction
            await expect(page.locator('text=Location (Recommended)')).toBeVisible();

            // Enable GPS capture
            const gpsSwitch = page.locator('[data-testid="gps-enabled-switch"]');
            ...
            // Set scheduled date
            await page.fill('[data-testid="scheduledDate-input"] input', '2024-01-15T14:30');
            ...
            await expect(page.locator('text=Product demonstration meeting')).toBeVisible();
        ...
        it('should handle offline interaction creation', async () => {
            ...
            await page.click('[data-testid="organizationId-input"] input');
            await page.type('[data-testid="organizationId-input"] input', 'Beta Inc');
            await page.click('text=Beta Inc');

            await page.click('[data-testid="typeId-input"]');
            await page.click('text=Call');

            await page.fill('[data-testid="subject-input"] input', 'Offline follow-up call');
            await page.fill('[data-testid="description-input"] textarea', 'Follow-up call scheduled while offline');
        ...
        it('should upload file attachments', async () => {
            ...
            // Fill out basic info
            await page.click('[data-testid="organizationId-input"] input');
            await page.type('[data-testid="organizationId-input"] input', 'Gamma Ltd');
            await page.click('text=Gamma Ltd');

            await page.click('[data-testid="typeId-input"]');
            await page.click('text=Demo/Sampled');

            await page.fill('[data-testid="subject-input"] input', 'Product sample with documentation');
        ...
        it('should handle form validation errors', async () => {
            ...
            await expect(page.locator('text=Organization is required') || page.locator('text=Required')).toBeVisible();
            await expect(page.locator('text=Subject is required') || page.locator('text=Required')).toBeVisible();
        });
        ...
        it('should show GPS accuracy warnings', async () => {
            ...
            await expect(page.locator('text=Consider moving to an open area')).toBeVisible();
        });
        ...
        it('should handle GPS permission denied', async () => {
            ...
            await expect(page.locator('text=Location access denied') || page.locator('text=GPS error')).toBeVisible();
        });
    });
    ...
    describe('Interaction List and Management', () => {
        it('should display interactions in list view', async () => {
            ...
            await expect(page.locator('[data-testid="interaction-row"]').first()).toBeVisible();
        });
        ...
        it('should search interactions by text', async () => {
            ...
            // Use search
            await page.fill('[data-testid="search-input"]', 'Product demonstration');
    ...
    describe('Mobile Responsiveness', () => {
        it('should work on mobile viewport', async () => {
            ...
            await expect(page.locator('.RaCreate-main')).toHaveClass(/RaCreate-main/);
        ...
        it('should handle touch interactions', async () => {
            ...
            await expect(page.locator('[data-testid="organizationId-input"] input')).toBeFocused();
            ...
            await expect(page.locator('[data-testid="subject-input"] input')).toBeFocused();
        });
    });
