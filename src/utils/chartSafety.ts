...
export function safeDivide(numerator: number | null | undefined, denominator: number | null | undefined): number {
    const num = typeof numerator === 'number' && isFinite(numerator) ? numerator : 0;
    const denom = typeof denominator === 'number' && isFinite(denominator) ? denominator : 0;
 ...
 */
export function safePercentage(value: number | null | undefined, total: number | null | undefined): number {
 ...
 */
export function safeTrend(current: number | null | undefined, previous: number | null | undefined): number {
