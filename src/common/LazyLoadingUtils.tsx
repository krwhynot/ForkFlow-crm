...
const LazyLoadError: React.FC<LazyLoadErrorProps> = ({ error, resetErrorBoundary }) => (
  <Box
    sx={{
      display: 'flex',
...
export class ResourcePreloader {
  ...
  static async processQueue() {
    ...
    const highPriority = this.preloadQueue.filter(c => c.priority === 'high');
    ...
    try {
      for (const config of [...highPriority, ...mediumPriority, ...lowPriority]) {
