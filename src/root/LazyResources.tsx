...
export const createLazyResourceObject = (moduleLoader: () => Promise<any>, fallback: React.ReactElement) => {
  return {
    list: React.lazy(() => moduleLoader().then(module => ({ default: module.default.list }))),
    create: React.lazy(() => moduleLoader().then(module => ({ default: module.default.create }))),
    edit: React.lazy(() => moduleLoader().then(module => ({ default: module.default.edit }))),
    show: React.lazy(() => moduleLoader().then(module => ({ default: module.default.show }))),
  };
};
